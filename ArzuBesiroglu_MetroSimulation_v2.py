...
# Versiyon 2 — Test senaryoları (tekrarsız durak isimleri)
print("\n=== Test Senaryoları ===")

def temizle_rota(rota):
    return [station for prev, station in zip([None] + rota, rota) if prev is None or station.ad != prev.ad]
